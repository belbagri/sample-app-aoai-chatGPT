                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Welcome to EconoBot</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Please ask any question you might have around the Bank's work</h2>
                            </Stack>
                        ) : (
